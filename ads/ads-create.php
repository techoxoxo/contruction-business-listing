...
//To check the Ad Post count with current plan starts

$plan_type_ad_post_count = $user_plan_type['plan_type_ad_post_count'];
$ad_post_count_user = getCountUserAdPost($_SESSION['user_id']);

if ($ad_post_count_user >= $plan_type_ad_post_count) {

    $_SESSION['status_msg'] = $BIZBOOK['Ad_POSTS_LIMIT_EXCEED_MESSAGE'];

    header('Location: db-ad-posts');
    exit();
}
//To check the Ad Post count with current plan ends
            ...
            <div class="login-main add-list">
                ...
                <div class="log">
                    <div class="login">
                        ...
                        <form action="ads_insert.php" class="ad_post_form" id="ad_post_form"
                              name="ad_post_form"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <select onchange="getadpostSubCategories(this.value)" name="category_id"
                                                     required="required" id="category_id" class="chosen-select form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 ads-gall">
                                            ...
                                            <div class="fil-img-uplo">
                                                ...
                                                <input type="file" name="gallery_image[]" accept="image/*,.jpg,.jpeg,.png" class="form-control" id="fileInput" required="required" multiple>
...
<script src="<?php echo $slash; ?>js/image-upload-24.js"></script>
