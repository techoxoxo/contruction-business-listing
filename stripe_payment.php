                    ...
                    <div class="login">
                        ...
                        <form name="payment_stripe_form" id="payment_stripe_form" method="post"
                            ...
                            <button type="submit" name="stripe_payment_submit" id="stripe_payment_submit"
                                ...
                                <?php echo $BIZBOOK['PAY']; ?> <?php if($footer_row['currency_symbol_pos']== 1){ echo $footer_row['currency_symbol']; } ?><?php echo $user_plan_type['plan_type_price']; ?><?php if($footer_row['currency_symbol_pos']== 2){ echo $footer_row['currency_symbol']; } ?>
