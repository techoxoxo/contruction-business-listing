                ...
                <div class="ud-cen-s2">
                    ...
                    <table class="responsive-table bordered" id="pg-resu">
                        ...
                        //To calculate the expiry date from user created date ends
                                ...
                                <td><span class="db-list-rat"><?php if($footer_row['currency_symbol_pos']== 1){ echo $footer_row['currency_symbol']; } ?> <?php if ($user_plan == 0) {
                                            echo "0";
                                        } else {
                                            echo $plan_type_row['plan_type_price'];
                                        } ?><?php if($footer_row['currency_symbol_pos']== 2){ echo $footer_row['currency_symbol']; } ?></span></td>
