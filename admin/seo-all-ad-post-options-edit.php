    ...
    <div class="ad-com pg-com">
        <div class="ad-dash leftpadd">
            <div class="ud-cen">
                <?php
                $ad_post_id = $_GET['row'];
                $row = getIdAdPost($ad_post_id);
                ?>
                <form name="all_ad_post_form" id="all_ad_post_form" method="post" action="update_seo_ad_post.php"
                      enctype="multipart/form-data" class="cre-dup-form cre-dup-form-show">
                    <input type="hidden" class="validate" id="ad_post_id" name="ad_post_id"
                           value="<?php echo $row['ad_post_id']; ?>" required="required">
                    <div class="pg-cen">
                        <div class="s-com pg-tit">
                            <h1>Edit Ad Post SEO options</h1>
                            <?php include "../page_level_message.php"; ?>
                            <div class="form-group">
                                <input type="text" required="required" class="form-control" value="<?php echo $row['ad_post_name']; ?>"
                                       disabled>
                            </div>
                        </div>
                    ...
                    <div class="pg-rhs">
                        <div class="box pub">
                            ...
                            <div class="inn">
                                <ul>
                                    <li>
                                        <button type="submit" name="ad-post-seo-submit" class="btn-pub">Save changes</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
