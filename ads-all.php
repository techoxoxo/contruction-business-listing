            ...
            <div class="ban-search">
                <form>
                    <ul>
                        ...
                        <li class="sr-time">
                            <select name="higlig" id="higlig" class="sort_by chosen-select form-control">
                                <option value="">Higlights</option>
                                <option value="">Higlights point 1</option>
                                <option value="">Higlights point 2</option>
                                <option value="">Higlights point 3</option>
                            </select>
                        </li>
                        <li class="sr-time">
                            <select name="sort_by" id="sort_by" class="sort_by chosen-select form-control">
                                <option value="">All Ads</option>
                                <option value="">Todays post</option>
                                <option value="">Recent posts</option>
                                <option value="">Newest posts first</option>
                                <option value="">Oldest posts first</option>
                            </select>
                        </li>
                        <li class="sr-date">
                            <div id="newdate"></div>
                    ...
                    while ($eventrow = mysqli_fetch_array($eventrs)) {
                        ...
                        <div class="plac-hom-box ad-box">
                                    <div class="plac-hom-box-im">
                                        <img src="ads/images/18.jpg" class="b-lazy b-loaded" alt="">
                                        <h4>$2000</h4>
                                    </div>
                                    <div class="ad-box-txt">
                                        <h3>Harley Davidson S440 - 2023 model</h3>
                                        <span class="loc">Manchester Township, New Jersey</span>
                                        <span class="dat">3 Days old</span>
                                    </div>
                                    <a href="#" class="fclick" tabindex="0"></a>
                                </div>
                        </li>
