...
$BIZBOOK['Ad_POSTS_LIMIT_EXCEED_MESSAGE'] = "Your Ad Post Limit Exceeded!! Upgrade your plan and enjoy our services";
...
$BIZBOOK['ADS_UPDATE_SUCCESS_MESSAGE'] = "Your Ad Post has been Updated Successfully!!!";

$BIZBOOK['ADS_DELETE_SUCCESS_MESSAGE'] = "Ad Post has been Deleted Successfully!!!";

$BIZBOOK['ADS_INSERT_SUCCESS_MESSAGE'] = "New Ad Post has been created Successfully!!!";
...
$BIZBOOK['ENQUIRY_ALL_LEADS_SUCCESS_MESSAGE'] = "Enquiry has been Moved to All Leads!!!";

$BIZBOOK['ENQUIRY_IMPORTANT_SUCCESS_MESSAGE'] = "Enquiry has been Moved to Important!!!";

$BIZBOOK['ENQUIRY_FAVOURITE_SUCCESS_MESSAGE'] = "Enquiry has been Moved to Favourite!!!";
...
$BIZBOOK['pg_privac_txt'] = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum";

$BIZBOOK['pg_terms_tit'] = "Terms of Use";
$BIZBOOK['pg_terms_txt1'] = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum";
...
//***** ADS MODULE 15Dec23 ***** */
$BIZBOOK['OPTIONS'] = "Options";
$BIZBOOK['IMPOR'] = "Important leads";
$BIZBOOK['ADS-CLASI'] = "Classifieds Ads";
$BIZBOOK['FAVORLEAD'] = "favourite leads";
$BIZBOOK['ADS-HOM-BAN-TIT'] = "Free classifieds in <strong>New york</strong>";
$BIZBOOK['ADS-HOM-BAN-SUBTIT'] = "Buy and Sell for free anywhere in <strong>India</strong> with <strong>OLX</strong> Online Classified Advertising";
$BIZBOOK['ADS-ALL-BAN-TIT'] = "Lands & Plots in Brooklyn";
$BIZBOOK['ADS-ALL-BAN-SUBTIT'] = "8,408 ads near The Bronx";
$BIZBOOK['ADS-CRE-ADD-NEW'] = "Add new Ads";
$BIZBOOK['ADS-CRE-EDIT'] = "Edit This Ad";
$BIZBOOK['ADS-CRE-ADD'] = "Post new Ads"; 
$BIZBOOK['ADS-CRE-AD-NAME'] = "Ad Post name";
$BIZBOOK['ADS-DASH-DETAIL'] = "Ad Details";
$BIZBOOK['ADS-CRE-AD-ADDRESS'] = "Address";
$BIZBOOK['ADS-CRE-AD-PRICE'] = "Price";
$BIZBOOK['ADS-ALL-ADS'] = "All Ads Posts";
$BIZBOOK['ADS-POST'] = "Add new Ad Post";
$BIZBOOK['ADS_POST_SEARCH_ADS_POST_PLACEHOLDER'] = "Search Ad Post in your city...";
$BIZBOOK['ADS_POST_HOME_PAGE_FIRST_DIV_TITLE'] = "Trending Ads";
$BIZBOOK['ADS_POST_HOME_PAGE_SECOND_DIV_TITLE'] = "Today Popular Ads";
$BIZBOOK['ADS_POST_HOME_PAGE_THIRD_DIV_TITLE'] = "All Ads";
$BIZBOOK['ADS_POST_HOME_PAGE_SUGGESTION_H2'] = "Start adding a new Post";
$BIZBOOK['ADS_POST_HOME_PAGE_SUGGESTION_P'] = "You can send the suggestion or request to the <b>Bizbook Admin</b>";
$BIZBOOK['ADS_POST_HOME_PAGE_SUGGESTION_A'] = "Submit a Post";
