                ...
                <div class="container">
                    <div class="row">
                        <div class="login-main add-list">
                            ...
                            <span class="steps">Delete this Ad</span>
                            <div class="log">
                                <div class="login">
                                    ...
                                    ?>
                                    <form action="trash_ad_post.php" class="ad_post_edit_form" id="ad_post_edit_form"
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <select disabled="disabled" onChange="getAdPostCities(this.value);" name="country_id" required="required"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <select disabled="disabled" data-placeholder="<?php echo "Select Your City"; ?>"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                <textarea readonly="readonly" class="form-control" required="required"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="submit" name="ad_post_submit" class="btn btn-primary">Delete Ad Post</button>
                                            </div>
                                        </div>
                                        <!--FILED END-->
                                    </form>
